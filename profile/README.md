...
#### `4.` Para hospedar seu bot ou site, existem 4 formas, pelo [Discord](https://docs.discloudbot.com/suporte/hospedar/bots/discord), [VSCode](https://marketplace.visualstudio.com/items?itemName=discloud.discloud), [CLI-js](https://www.npmjs.com/package/discloud-cli) ou [CLI-rust](https://github.com/discloud/cli-rust)
